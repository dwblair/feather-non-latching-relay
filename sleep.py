...
parser.add_argument('-s', '--sleep', help='turn off relay, then wait this many seconds, then turn relay back on', type=int, required=True)
...
print 'Waiting for %d seconds, then turning relay off for %d seconds ...' % (WAIT, SLEEP)
